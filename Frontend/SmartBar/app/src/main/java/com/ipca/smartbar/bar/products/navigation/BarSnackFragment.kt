...
class BarSnackFragment(private val token: String?) : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.buttonAddProduct.text = "ADICIONAR SNACKS"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        BarProductsRequests.getSnacks(lifecycleScope, token){
            products = it
        ...
        buttonAddProduct.setOnClickListener() {
            val fragment = AddProductFragment(2, token)
